package org.firstinspires.ftc.teamcode.team17104;
...
@Autonomous(name = "startClose-high-bucket-auto", group = "competition")
public class BlackAuto3 extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        moveRobot(1, 1, 0.2);
        moveArm(1, 0.17);  // Raise Arm
        moveRobot(WAIT);
        moveRobot(WAIT);
        armElbow.setPosition(0.1);
        moveRobot(WAIT);
        moveGecko(1, 4);  //Drop Sample
        moveRobot(WAIT);
        armElbow.setPosition(minPosition); // Set Arm Up
        moveArm(-0.5, 1);  // Lower Arm
